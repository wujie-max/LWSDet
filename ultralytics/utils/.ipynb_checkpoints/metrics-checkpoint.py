...
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, SIoU=False, EIoU=False, WIoU=False, Focal=False, TIou = False,
    ...
    if CIoU or DIoU or GIoU or EIoU or SIoU or WIoU or TIou:
        ...
        if CIoU or DIoU or EIoU or SIoU or WIoU or TIou:  # Distance or Complete IoU https://arxiv.org/abs/1911.08287v1
            ...
            if CIoU:  # https://github.com/Zzh-tju/DIoU-SSD-pytorch/blob/master/utils/box/box_utils.py#L47
                ...
                s1 = w1 * h1
                s2 = w2 * h2
                size_ratio = (s1 + s2) / 2  # 真值框和预测框的平均大小
                iou = torch.pow(inter / (size_ratio + eps), alpha)  # alpha iou
                # SIou
                s_cw = (b2_x1 + b2_x2 - b1_x1 - b1_x2) * 0.5 + eps
                s_ch = (b2_y1 + b2_y2 - b1_y1 - b1_y2) * 0.5 + eps
                sigma = torch.pow(s_cw ** 2 + s_ch ** 2, 0.5)
